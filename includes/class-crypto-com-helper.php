 ...
 * Currency Helper
 */
class Crypto_Currency_Helper
{
    public static function get_crypto_currency($key) {
        $currencies = array (
            'AFN' => 
            array (
              'alphabeticCode' => 'AFN',
    ...
    public static function get_crypto_currency_in_subunit($key, $amount) {
        $currency = self::get_crypto_currency($key);
        $no_decimal_places = is_null($currency) ? 2: $currency['minorUnit'];
        return (float) $amount * pow(10, $no_decimal_places);
    }

    public static function get_crypto_currency_in_unit($key, $amount) {
        $currency = self::get_crypto_currency($key);
        $no_decimal_places = is_null($currency) ? 2: $currency['minorUnit'];
        return (float) $amount / pow(10, $no_decimal_places);
    }
