 ...
 * @subpackage Crypto_Com_Memberpress_Payment_Gateway/public
 */
 ...
 */
class Crypto_Com_Memberpress_Payment_Gateway_Public {
	...
	public function enqueue_styles() {
		...
		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/crypto-com-memberpress-payment-gateway-public.css', array(), $this->version, 'all' );
